...
- `TASK-055` (`P0`, `done`): Content workflow pack (article/social/localization)
...
- `TASK-073` (`P1`, `in_progress`): Restart persistence invariant tests
- `TASK-074` (`P1`, `in_progress`): Security and policy adversarial tests
